...
namespace DataJuggler.Blazor.Components.Util
{
    ...
    public class GridHelper
    {
        ...
        #region Methods
            ...
            #region GetPage<IGridValueProvider>(List<IGridValueProvider> items, , List<GridColumn> columns, int itemsPerPage = 0, int currentPage = -1)
            /// <summary>
            /// method returns a PageResponse
            /// </summary>
            public static PageResponse GetPage<IGridValueProvider>(List<IGridValueProvider> items, List<GridColumn> columns, int itemsPerPage = 0, int currentPage = -1)
            {
                // initial value
