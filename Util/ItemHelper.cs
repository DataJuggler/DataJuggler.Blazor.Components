...
namespace DataJuggler.Blazor.Components.Util
{
    ...
    {  
        ...
        #region Methods
            ...
            #region FindItemById(List<Item> items, int id)
            /// <summary>
            /// method returns the Item By Id
            /// </summary>
            public static Item FindItemById(List<Item> items, int id)
            {
                // initial value
                Item item = null;
            ...
            #region FindItemByText(List<Item> items, string text)
            /// <summary>
            /// method returns the Item By Text
            /// </summary>
            public static Item FindItemByText(List<Item> items, string text)
            {
                // initial value
                Item item = null;
