...
# Example Calendar
    ...
    <CalendarComponent Unit="px" HeightUnit="px" CalendarTop="-272" Parent="this"
        CalendarLeft="256" Width="224" Column2Width="128"
        TextBoxWidth="124" ButtonLeft="-26" ButtonTop="-.6">
    </CalendarComponent>
